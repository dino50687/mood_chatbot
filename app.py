    ...
    def get_response(self, mood, user_message):
        responses = {
            "happy": [
                ...
                "You're glowing with happiness and I love that for you! Keep shining!",
                "Your happiness lights up this whole space! What's making you feel this amazing?",
                "This is your energy ? vibrant, alive, unstoppable. Savor it!",
            ],
            "sad": [
                f"I hear you, and I'm here with you. It's okay to feel this way. {random.choice(['??', '??', '??'])}",
                "Those feelings are valid. Take a deep breath ? you're not alone in this.",
                "Sometimes we just need to sit with our feelings. I'm right here beside you.",
                "It hurts now, but storms don't last forever. The sun always finds its way back.",
                "Your feelings matter. Let it out ? I'm listening, really listening.",
            ],
            "stressed": [
                f"Take a breath with me. In... and out... You've got this. {random.choice(['??', '??', '??'])}",
                "Let's press pause together. You don't have to solve everything right now.",
                "The pressure is real, but so is your strength. One step at a time.",
                "Close your eyes for a moment. Imagine a calm ocean. You're the stillness above it.",
                "You're carrying a lot, and you're doing an incredible job. Let's lighten the load.",
            ],
            "angry": [
                f"I feel that fire. Let's channel it into something powerful. {random.choice(['??', '??', '??'])}",
                "Your voice matters. Let that passion fuel something amazing.",
                "It's okay to be angry. What matters is what we do with that fire.",
                "That intensity? That's power. Let's aim it, not suppress it.",
                "Breathe with me. Let the heat pass through you like a wave.",
            ],
            "romantic": [
                f"There's something magical in the air tonight... {random.choice(['??', '??', '??'])}",
                "Love makes everything more beautiful. You're glowing with it.",
                "Cherish every moment of this feeling ? it's one of life's greatest gifts.",
                "The universe leans in when hearts speak. Tell me more.",
                "Romance isn't just a feeling ? it's the poetry we live.",
            ],
            "energetic": [
                f"LET'S GO! That energy is ELECTRIC! {random.choice(['??', '??', '??'])}",
                "I'm matching your energy right now! This is what being alive feels like!",
                "You're a force of nature! Channel that power into something epic!",
                "The universe can feel your vibration! Keep riding that wave!",
                "Energy like yours moves mountains. What are we conquering today?",
            ],
            "chill": [
                f"Everything is flowing. Just vibe with it. {random.choice(['??', '??', '??'])}",
                "This peaceful energy is everything. Let's stay here a while.",
                "No rush, no pressure. Just good vibes and good music.",
                "You've found your center. Hold onto this peace.",
                "The world slows down when you do. Breathe it in.",
            ],
            "nostalgic": [
                f"Those memories shaped you. Honor them. {random.choice(['??', '??', '??'])}",
                "The past lives in us, making us who we are. That's beautiful.",
                "Some memories are like old photographs ? faded but precious.",
                "Looking back isn't going backward. It's gathering the gems.",
                "The best part? You can create new beautiful memories starting now.",
            ],
            "confident": [
                f"THAT'S IT! THAT'S THE ENERGY! YOU'RE UNSTOPPABLE! {random.choice(['??', '??', '??'])}",
                "Look at you owning it! This is your moment, your world!",
                "Confidence looks incredible on you! Remember this feeling.",
                "You weren't built to blend in. You were built to stand out.",
                "The world is yours for the taking. Go claim what's yours.",
            ],
            "bored": [
                f"Let's shake things up! Adventure is calling. {random.choice(['??', '??', '??'])}",
                "Time to add some color to the canvas! What sounds fun to you?",
                "Boredom is just the universe nudging you toward something new.",
                "Let me find you something that'll wake up those neurons!",
                "Every great story starts with 'I was bored, so...' Let's begin yours.",
            ],
        }
